  ...
  (a = (function (t) {
    ...
    (e = (function () {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          for (
            t = this.getElement(),
              r = "translate3d(" + (0 | this.progress) + "%, 0, 0)",
      ...
      return (
        (t.prototype.trigger = function (t, e) {
          ...
          if (null != this.bindings[t]) {
            for (o = this.bindings[t], i = [], r = 0, s = o.length; s > r; r++)
    ...
    L().on("request", function (e) {
      ...
      return (
        ...
        N(i)
          ? void 0
          : c.running || (j.restartOnRequestAfter === !1 && "force" !== _(o))
          ? void 0
          : ((r = arguments),
            ...
            setTimeout(function () {
              ...
              if (
                (e =
                  "socket" === o
                    ? s.readyState < 2
                    : 0 < (u = s.readyState) && 4 > u)
              ) {
                for (
                  c.restart(), a = c.sources, l = [], n = 0, i = a.length;
                  i > n;
                  n++
                ) {
          ...
          for (
            n = null,
              t.addEventListener(
                "progress",
                function (t) {
                  return (u.progress = t.lengthComputable
                    ? (100 * t.loaded) / t.total
                    : u.progress + (100 - u.progress) / 2);
                },
                !1
              ),
    ...
    (T = function () {
      ...
      for (
        a = null != (u = j.extraSources) ? u : [], r = 0, o = a.length;
        o > r;
        r++
      )
        (F = a[r]), C.push(new F(j));
    ...
    (c.stop = function () {
      return (
        ...
        y.destroy(),
        (v = !0),
        null != d && ("function" == typeof w && w(d), (d = null)),
        T()
      );
    }),
    (c.restart = function () {
    ...
    (c.go = function () {
      ...
      return (
        ...
        (d = M(function (e, n) {
          ...
          for (
            p = 100 - y.progress, s = d = 0, o = !0, a = m = 0, b = C.length;
            b > m;
            a = ++m
          )
            for (
